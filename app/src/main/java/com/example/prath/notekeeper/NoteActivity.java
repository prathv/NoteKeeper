package com.example.prath.notekeeper;
...
public class NoteActivity extends AppCompatActivity {
    public static final String NOTE_INFO = "com.example.prath.notekeeper.NOTE_INFO";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<CourseInfo> adapterCourses = new ArrayAdapter<CourseInfo>(this, android.R.layout.simple_spinner_dropdown_item,courseInfos);
